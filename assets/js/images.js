// /assets/js/images.js
// Headshot resolver shared by all pages. Prefers Bioguide CDN, then custom photo, then placeholder.

const PLACEHOLDER = "data:image/svg+xml;utf8," + encodeURIComponent(
  "<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 64 64'><rect width='64' height='64' fill='#e9eef5'/>" +
  "<g fill='#98a5b4'><circle cx='32' cy='24' r='12'/>" +
  "<rect x='10' y='40' width='44' height='16' rx='8'/></g></svg>"
);

export function headshot(member, size = "225x275") {
  const bio = (member?.bioguide_id || member?.bioguide || member?.id || "").trim();
  if (bio) {
